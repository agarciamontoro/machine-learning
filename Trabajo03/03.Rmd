...
# Cálculo de errores
lm.h.err <- mean((predict(lm.h, Auto.test, type="response") - Auto.test[,"mpg"])^2)
lm.d.err <- mean((predict(lm.d, Auto.test, type="response") - Auto.test[,"mpg"])^2)
lm.w.err <- mean((predict(lm.w, Auto.test, type="response") - Auto.test[,"mpg"])^2)
...
A la vista de este resultado podemos concluir que el comportamiento de los residuos no presenta ningún indicio de *underfitting* con respecto al parámetro $\lambda$.
