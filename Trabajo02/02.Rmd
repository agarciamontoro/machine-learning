...
a_q <- rnorm(N+1) / sqrt(sum(sapply(seq(0,Qf), function(q){1 / (2*q + 1)})))
...
# Generamos los datos que deben ser ajustados
...
Podemos estimar el error medio cuadrático fuera de la muestra con una muestra de test sin ruido:
...
sum((leg.test.Y - g2.test.Y)^2)/50
sum((leg.test.Y - g10.test.Y)^2)/50
```
