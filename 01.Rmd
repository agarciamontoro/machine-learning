...
etiquetas_2 <- genera_grafico(unif.x, unif.y, f2, cex=0.25)
etiquetas_3 <- genera_grafico(unif.x, unif.y, f3, cex=0.25)
etiquetas_4 <- genera_grafico(unif.x, unif.y, f4, cex=0.25)
etiquetas_5 <- genera_grafico(unif.x, unif.y, f5, cex=0.25)
