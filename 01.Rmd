...
genera_grafico(x, y, f2, generarRuido = T, cex=0.25)
genera_grafico(x, y, f3, generarRuido = T, cex=0.25)
genera_grafico(x, y, f4, generarRuido = T, cex=0.25)
genera_grafico(x, y, f5, generarRuido = T, cex=0.25)
...
pruebita <- lapply(simula_unif(10, 2, c(0,1)), wrapper)
media <- mean(unlist(pruebita))
